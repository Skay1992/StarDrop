...
Кнопка `💬 Поддержка` принимает вопросы прямо внутри бота и отправляет их администратору. Администратор может посмотреть последние 10 обращений командой `/support_tickets`.
